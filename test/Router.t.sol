...
contract RouterTest is Test, Utils {
    ...
    function test_oppositeDirectionSwapExecution_success() public {
        ...
        */
        ...
        uint256 tokenASwapAmount = 21e18;
        ...
        uint256 streamsBeforeSwapAtoB = swapsAtoB[frontAtoB].streamsRemaining; // should be consumed
        ...
        console.log(swapBtoAPerStreamLocal,"swapBtoAPerStreamLocal");
        ...
        console.log("AMMMOUNTTT %s",swapsBtoA[frontBtoA].amountOut); // should return 0.
      ...
      function test_oppositeDirectionSwapExecution_success3() public {
        ...
        */
        ...
        console.log(swapAtoB.swapPerStream,"swapAtoB.swapPerStream");
        (uint256 reserveDAa,, uint256 reserveAAa,,,,,) = pool.poolInfo(address(tokenA));
